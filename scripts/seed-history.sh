...
add_commit_at "2025-05-26T11:30:00+02:00" "feat: add NSFW/uncensored models (Dolphin, Wizard Vicuna)"

add_commit_at "2025-05-26T14:00:00+02:00" "feat: add heretic suggestion for NSFW use case"
